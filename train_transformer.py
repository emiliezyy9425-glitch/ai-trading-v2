"""Final training pipeline for the Transformer classifier."""
...
def _load_params(config_path: Path | None) -> Dict[str, Any]:
...
def main() -> None:
    ...
    parser.add_argument("--config", type=Path, default=Path("transformer_config.json"), help="Path to the JSON config file")
